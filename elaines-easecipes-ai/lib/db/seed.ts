...
const seedRecipes = [
  ...
  },
  {
    ...
    directions: JSON.stringify([
      ...
      "title: Assemble:",
      "Once the dough has doubled in size, roll out the dough into a 9x11 inch rectangle.",
      "Spread room-temperature butter onto the dough, leaving a 1/4 inch lip on the far side. Then spread the granulated sugar, lemon zest, and blueberrieson top of the buttered surface in an even layer.",
      "Roll the dough into a log shape, starting from the close side. Cut your rolled log of dough into 12 portions. <br><i><b>Tip:</b> Use unflavoured floss to cut the dough so that it stays round.</i>",
      "Grease a 9x11 inch pan and place the rolls in the pan. Cover and place in a warm spot to let rise for 30-45 mins.",
      "Preheat the oven to 350\u00B0F. Bake the rolls for 20-25 mins.",
    ]),
...
const seedIngredientMeasUnit = [
  ...
  //Blueberry Rolls
  {recipe_id: 'blueberry-rolls', component: 'Dough:', amount: '3/4', measUnit_id: 'cup(s)', ingredient_id: 'Whole Milk', min_amount: '3/4'},
  {recipe_id: 'blueberry-rolls', component: 'Dough:', amount: '2 1/4', measUnit_id: 'tsp(s)', ingredient_id: 'Yeast', min_amount: '2 1/4'},
  {recipe_id: 'blueberry-rolls', component: 'Dough:', amount: '1/4', measUnit_id: 'cup(s)', ingredient_id: 'Granulated Sugar', min_amount: '1/4'},
  {recipe_id: 'blueberry-rolls', component: 'Dough:', amount: '1', measUnit_id: ' ', ingredient_id: 'Egg(s)', min_amount: '1'},
  {recipe_id: 'blueberry-rolls', component: 'Dough:', amount: '1', measUnit_id: ' ', ingredient_id: 'Egg Yolk(s)', min_amount: '1'},
  {recipe_id: 'blueberry-rolls', component: 'Dough:', amount: '1/4', measUnit_id: 'cup(s)', ingredient_id: 'Unsalted Butter', min_amount: '1/4'},
  {recipe_id: 'blueberry-rolls', component: 'Dough:', amount: '2 3/4', measUnit_id: 'cup(s)', ingredient_id: 'Flour', min_amount: '2 3/4'},
