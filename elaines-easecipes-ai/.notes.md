...
First Make sure you're in the elaines-easecipes-ai folder
```bash
npm run db:generate #only run when db schema changes are made (craetes a list of the things that need to change when migration happens)
