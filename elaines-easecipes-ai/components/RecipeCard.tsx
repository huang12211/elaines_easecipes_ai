...
export default function RecipeCard({
  ...
  return (
    <Link 
    href={`/recipes/${slug}`} 
    className="hover:scale-1.02 relative block aspect-square w-full max-w-70 min-w-40 shrink-0 cursor-pointer justify-self-center overflow-hidden rounded-[16px] shadow-[4px_4px_4px_rgba(0,0,0,0.25)] transition-transform"
    >
      ...
      <div className="absolute top-[5px] left-2 flex flex-wrap gap-1">
        {tags.map((cat, index) => (
          <div key={index} className="rounded-[30px] border-2 border-[#FF2693] bg-[#FFF7FA] px-3 pt-px pb-[3px]">
      ...
      <div className="absolute bottom-0 left-0 flex h-auto min-h-[50px] w-[85%] flex-col justify-between overflow-hidden rounded-tr-[10px] rounded-bl-[16px] bg-white p-1.5">
        <div className="flex w-full items-start justify-between gap-2">
          ...
          <button aria-label="Bookmark Recipe Button">
            <div className="relative h-3.5 w-3 sm:mt-0.25 sm:mr-0.5 md:mt-0.5 md:mr-0.5 md:h-4 md:w-3.5">
              <Image
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <div className="flex items-center gap-[6px]">
            <svg className="h-3.5 w-3 sm:h-4 sm:w-3.5 md:h-[18px] md:w-4" viewBox="0 0 10 7" fill="#E0165C" xmlns="http://www.w3.org/2000/svg">
