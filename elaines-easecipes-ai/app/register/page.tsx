...
export default function RegisterPage() {
  ...
  return (
    <div className="bg-white min-h-screen w-full max-w-[1440px] mx-auto relative">
      ...
      <div
        className="relative min-h-[calc(100vh-53px)] flex flex-col"
        style={{
          background:
      ...
      >
        ...
        {/* Footer */}
        <footer className="relative bg-[#094234] w-full py-8 flex items-center justify-center">
          <p className="font-bold text-xs text-white text-center tracking-[-0.24px]">
